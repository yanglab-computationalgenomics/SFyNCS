...
say join "\t", ("Chr_breakpoint_1", "Pos_breakpoint_1", "Strand_breakpoint_1", "Chr_breakpoint_2", "Pos_breakpoint_2", "Strand_breakpoint_2", "Junction_type", "Cluster_id",
                "Split_read_count", "Read_pair_count", "Minimum_read_pair_distance_to_breakpoint_1", "Minimum_read_pair_distance_to_breakpoint_2", "Split_reads", "Read_pairs",
...
sub process_cluster{
    ...
    until(@Split_reads_info==0){		
        ...
        my ($output_read_pairs, $output_min_read_pair_distance_breakpoint_1, $output_min_read_pair_distance_breakpoint_2, $output_read_pair_distance_breakpoint_1, $output_read_pair_distance_breakpoint_2)=("NA") x 5;
        ...
        foreach $process_line (@Span_reads_info){
            ...
            if($is_breakpoint_1_support==1 && $is_breakpoint_2_support==1){
                ...
                my $temp_distance;
                if($output_strand_breakpoint_1 eq '+'){
                    $temp_distance=$output_pos_breakpoint_1 - $process_pos_breakpoint_1;
                }else{
                    $temp_distance=$process_pos_breakpoint_1 - $output_pos_breakpoint_1;
                }
                $output_read_pair_distance_breakpoint_1.=",".$temp_distance;
                $output_min_read_pair_distance_breakpoint_1=$temp_distance if $output_min_read_pair_distance_breakpoint_1 eq "NA" || $output_min_read_pair_distance_breakpoint_1 > $temp_distance;
                
                if($output_strand_breakpoint_2 eq '+'){
                    $temp_distance=$output_pos_breakpoint_2 - $process_pos_breakpoint_2;
                }else{
                    $temp_distance=$process_pos_breakpoint_2 - $output_pos_breakpoint_2;
                }
                $output_read_pair_distance_breakpoint_2.=",".$temp_distance;
                $output_min_read_pair_distance_breakpoint_2=$temp_distance if $output_min_read_pair_distance_breakpoint_2 eq "NA" || $output_min_read_pair_distance_breakpoint_2 > $temp_distance;
            }
        }
        
        $output_read_pairs=~s/^NA,//;
        $output_read_pair_distance_breakpoint_1=~s/^NA,//;
        $output_read_pair_distance_breakpoint_2=~s/^NA,//;
        say join "\t", ($output_chr_breakpoint_1, $output_pos_breakpoint_1, $output_strand_breakpoint_1, $output_chr_breakpoint_2, $output_pos_breakpoint_2, $output_strand_breakpoint_2, $output_junc_type, $output_cluster_id,
            $output_split_read_count, $output_read_pair_count, $output_min_read_pair_distance_breakpoint_1, $output_min_read_pair_distance_breakpoint_2, $output_split_reads, $output_read_pairs,
            $output_read_pair_distance_breakpoint_1, $output_read_pair_distance_breakpoint_2);
    }
